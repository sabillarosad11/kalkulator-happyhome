...
const TheLeafPlatinum = () => {
    ...
    const handleUnit = (e) => {
        e.target.value === "30/60" ? setHargaJual(189000000) : e.target.value === "33/60" ? setHargaJual(189000000) : e.target.value === "32/70" ? setHargaJual(250000000) : e.target.value === "42/80" ? setHargaJual(420000000) : setHargaJual(0)
    };
...
export default TheLeafPlatinum